...
def Analysis():
    ...
    print("Endind with Strategy", if_strat)
    print("Endind with Market", if_strat)
    ...
    print("Average Investment return:", str(avg_market) + "% more")
    print("Average Market return:", str(avg_strat) + "% more")
